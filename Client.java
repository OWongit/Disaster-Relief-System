...
public class Client {
    ...
    public static Set<Allocation> generateOptions(double budget, List<Location> sites) {
        Set<Allocation> alSet = new HashSet<Allocation>();
        
        
        return alSet;
    }

    private static Set<Allocation> generateOptions(double budget, List<Location> sites, Set<Allocation> optionsSoFar){
        double budgetSoFar = budget;
        for(optionsSoFar : Location){
